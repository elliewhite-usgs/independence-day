...
```{r readdata}
iday <- read.csv("iday.csv", fileEncoding="UTF-8-BOM", na.strings=c(""))
...
iday_subset <- iday[1:10, ]

ggplot(iday_subset, aes(monthweek, weekdayf, fill = 1)) + 
  geom_tile(colour = "white") + 
  facet_grid(year(iday_subset$DATE)~monthf) + 
